...
class Updater {
    constructor(instance) {
        ...
        this.pendingCallbacks = []  // 回调函数处理数组
        this.isPending = false
    ...
    addState(nextState) {
        if (nextState) {
            ...
            if (!this.isPending) {
                // 如果没有在工作 问题？什么时候打开什么时候关闭呢
                // 组件初始化结束 基本就刮起了 等程序稳定 false状态了 点击事件激活了这个事件 会打开开关
                this.emitUpdate()
            }
        }
    }
...
export default class Component {
    ...
    setState(nextState, callback) {
        ...
        // 将我们下一次的state添加到我们的更新器中，并不是直接去更新
