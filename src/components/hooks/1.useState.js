...
/**
 * 1. useState 就是一个 hook 都是函数 以 use开头
 ...
 * 5. 每次组件渲染都是独立的闭包 ，就是说每次渲染 用的变量都不是同一个
 */
...
function useState (initialState) {
  memoizedStates[index] = memoizedStates[index] || typeof initialState === 'function' ? initialState() : initialState
